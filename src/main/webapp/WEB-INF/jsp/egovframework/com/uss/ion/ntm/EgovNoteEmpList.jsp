	...
	<div class="pop_search_box" title="<spring:message code="common.searchCondition.msg" />">
 		<ul>
 			<li>
  			...
  			<li>
   				<input class="s_input" name="searchKeyword" title="<spring:message code="title.search"/>" type="text" size="35" <spring:message code="input.input" />"  onkeyup="if(window.event.keyCode==13){fn_egov_search_NoteEmp(); return false;} value='<c:out value="${mberVO.searchKeyword}"/>' maxlength="255"><!-- 검색창 -->
		...
		<thead>
			<tr>
    			...
    			<th><spring:message code="comUssIonNtm.NoteEmpList.address" /></th><!-- 주소 -->
  				<th><center><input type="checkbox" name="checkAll" title="<spring:message code="comUssIonNtm.NoteEmpList.all" />" id="checkAll" value="1" onClick="fn_egov_checkAll_NoteEmp();"></center></th><!-- 전체선택 -->
			</tr>
		</thead>
